...
const SideContent: React.FC<SideContentProps> = ({title, description, buttonlabel, buttonlink, css}) => {
  return (
    <>
      <div className={`${css}`}>
        <h6 className="text-sm font-bold tracking-wider text-primary-500 uppercase">About Us</h6>
